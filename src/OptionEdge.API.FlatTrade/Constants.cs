...
namespace OptionEdge.API.FlatTrade
{
    public class Constants
    {
        ...
        public const string TRANSACTION_TYPE_BUY = "B";
        public const string TRANSACTION_TYPE_SELL = "S";
        ...
        public const string PRICE_TYPE_LIMIT = "LMT";
        public const string PRICE_TYPE_MARKET = "MKT";
        public const string PRICE_TYPE_SL_LIMIT = "SL-LMT";
        public const string PRICE_TYPE_SL_MARKET = "SL-MKT";

        public const string PRODUCT_CODE_MIS = "I";
        public const string PRODUCT_CODE_NRML = "M";
        public const string PRODUCT_CODE_CNC = "C";
        public const string PRODUCT_CODE_CO = "H";
        public const string PRODUCT_CODE_BO = "B";
